          ...
          <article>
            ...
            <header class="article-header">
              <?php
                ...
                if(isset($first_section_header['article_header']['image'])){
                  echo '<img src="' . esc_url($first_section_header['article_header']['image']['url']) . '" class="img-fluid d-block mb-4" alt="' . esc_attr($first_section_header['article_header']['image']['alt']) . '" />';
                }

                if(isset($first_section_header['article_header']['title'])){
                  echo '<h1 class="home-page-title">' . esc_html($first_section_header['article_header']['title']) . '</h1>';
                }

                if(isset($first_section_header['article_header']['subtitle'])){
                  echo '<p class="subtitle">' . esc_html($first_section_header['article_header']['subtitle']);
                }
              ?>
            </header>
      ...
      <article>
        <header class="article-header">
          <?php
            ...
            if(isset($second_section_header['article_header']['image'])){
              echo '<img src="' . esc_url($second_section_header['article_header']['image']['url']) . '" class="img-fluid d-block mb-auto" alt="' . esc_attr($second_section_header['article_header']['image']['alt']) . '" />';
            }

            if(isset($second_section_header['article_header']['title'])){
              echo '<h2>' . esc_html($second_section_header['article_header']['title']) . '</h2>';
            }

            if(isset($second_section_header['article_header']['subtitle'])){
              echo '<p class="subtitle">' . esc_html($second_section_header['article_header']['subtitle']) . '</p>';
            }
          ?>
        </header>
        ...
        <article>
          <header class="article-header">
            <?php
              ...
              if(isset($explore_section_header['article_header']['image'])){
                echo '<img src="' . esc_url($explore_section_header['article_header']['image']['url']) . '" class="img-fluid d-block mb-4" alt="' . esc_attr($explore_section_header['article_header']['image']['alt']) . '" />';
              }

              if(isset($explore_section_header['article_header']['title'])){
                echo '<h2>' . esc_html($explore_section_header['article_header']['title']) . '</h2>';
              }

              if(isset($explore_section_header['article_header']['subtitle'])){
                echo '<p class="subtitle">' . esc_html($explore_section_header['article_header']['subtitle']) . '</p>';
              }
            ?>
          </header>
          ...
          <div id="cat-links-container">
            <div id="cat-links" class="tab-content">
              <?php $sc = 0; foreach($shop_cats as $shop_cat):
                ...
                $shop_cat_link = get_category_link($shop_cat->term_id);
              ?>
        ...
        <article>
          <header class="article-header">
            <?php
              ...
              if(isset($options_section_header['article_header']['image'])){
                echo '<img src="' . esc_url($options_section_header['article_header']['image']['url']) . '" class="img-fluid d-block mb-4" alt="' . esc_attr($options_section_header['article_header']['image']['alt']) . '" />';
              }

              if(isset($options_section_header['article_header']['title'])){
                echo '<h2>' . esc_html($options_section_header['article_header']['title']) . '</h2>';
              }

              if(isset($options_section_header['article_header']['subtitle'])){
                echo '<p class="subtitle">' . esc_html($options_section_header['article_header']['subtitle']) . '</p>';
              }
            ?>
          </header>
          ...
          <?php
            ...
            if($custom_options_section_link): ?>
              <a href="<?php echo esc_url($custom_options_section_link['url']); ?>" class="btn-main"><?php echo esc_html($custom_options_section_link['title']); ?></a>
          <?php endif; ?>
        </article>
      </div>
    </div>
